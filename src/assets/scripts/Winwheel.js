...
export class Winwheel {
  ...
  startAnimation () {
    if (this.animation) {
      ...
      const properties = new Array(null)
...
function winwheelAnimationLoop () {
  if (winwheelToDrawDuringAnimation) {
    ...
    const callbackBefore = winwheelToDrawDuringAnimation.animation.callbackBefore
    const callbackAfter = winwheelToDrawDuringAnimation.animation.callbackAfter
...
function winwheelTriggerSound () {
  ...
  const callbackSound = winwheelToDrawDuringAnimation.animation.callbackSound
...
function winwheelStopAnimation (canCallback) {
  ...
  if (canCallback != false) {
    const callback = winwheelToDrawDuringAnimation.animation.callbackFinished
